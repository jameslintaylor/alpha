...
\def\plaintitle{SIGCHI Extended Abstracts Sample File: Note Initial
  Caps} \def\plainauthor{Ryan Marks, Nick Morrison, Phillip Tran,
  James Taylor}
\def\emptyauthor{}
...
\author{%
  \alignauthor{%
    ...
    \email{studentID@mcmaster.ca} }\alignauthor{%
    \textbf{Nick Morrison}\\
    \affaddr{student-id}\\
    \affaddr{student-number}\\
    \email{studentID@mcmaster.ca} } \vfil \alignauthor{%
    \textbf{Phillip Tran}\\
    \affaddr{student-id}\\
    \affaddr{student-number}\\
    \email{studentID@mcmaster.ca} }\alignauthor{%
