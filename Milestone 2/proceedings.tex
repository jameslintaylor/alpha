...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{{figures/NeedToMeet/HTA_host.png}}
\caption{Task Diagram}
\label{fig:NTM_HTA_Host}
\end{figure}
Figure \ref{fig:NTM_HTA_Host} shows the diagram for the major tasks meeting hosts do. These include: 
\begin{enumerate}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{{figures/NeedToMeet/HTA_attend.png}}
\caption{Task Diagram}
\label{fig:NTM_HTA_Attend}
\end{figure}
...
Some of the few high level goals that Outlook can help a user achieve is date/meeting management and email management.

\subsection{Date/Meeting Management}
For date/meeting management, Outlook allows one to set up a calender between users through the Microsoft Exchange Server. After setting up the calender, all users with access to the calender can set up meetings and/or notifications for important dates like appointments. In addition to this, if there are many important dates, a user can efficiently check their dates through the schedule view.

\subsection{Email Management}
For email management, similar to the meeting management, Outlook allows a user to manage their own personal email as well as a shared email server where users can send emails within the server; this allows users to find important people to email, as they will spend less time searching for the email address.
