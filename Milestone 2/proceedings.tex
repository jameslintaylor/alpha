...
\end{itemize}
\subsection{Tasks}
\subsubsection{Creating the Meeting}
\begin{enumerate}
	\item Navigate to the website and click "Schedule a Meeting"
	\includegraphics[width=\columnwidth]{{figures/ntm_create_1.png}}	
	\item Enter meeting, time, place, duration (optionaly leave email address for contact updates)
	\includegraphics[width=\columnwidth]{{figures/ntm_create_2.png}}
	\item Schedule timeslots using a calendar interface and optionally
	invite people by email via the website or invite through a generated url
	\includegraphics[width=\columnwidth]{{figures/ntm_create_3.png}}
\end{enumerate}
\subsubsection{Indicating Availability}
\begin{enumerate}
	\item Navigate to the website through the provided URL
	\includegraphics[width=\columnwidth]{{figures/NeedToMeet/Attend_Images/1.png}}
	\item Select available dates and times, enter name and submit
	\includegraphics[width=\columnwidth]{{figures/NeedToMeet/Attend_Images/2.png}}
\end{enumerate}
