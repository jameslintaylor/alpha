...
\end{figure}
Figure \ref{fig:NTM_HTA_Host} shows the diagram for the major tasks users of "Need to Meet" perform. These include: 
\begin{enumerate}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{{Outlook/Create_Meeting.png}}
\caption{Task Diagram}
\label{fig:OUT_MEET_HTA}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{{Outlook/Sending_Email.png}}
\caption{Task Diagram}
\label{fig:OUT_SEND_HTA}
\end{figure}
