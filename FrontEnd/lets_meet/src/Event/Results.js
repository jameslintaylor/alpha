...
const resultForDate = (invitees, date) => {
...
const Results = ({invitees, dates}) => {
  console.log(dates.length)
  // let rows = dates.map(partial(_rowElementForDate, invitees))
  return (
  <div className="page">
    <a href="/"><img src={Logo} alt="logo" id="top-logo" /></a>
    <div id="results-container">
      {dates.map(partial(resultForDate, invitees))}
    </div>
  </div>
)}
